...
<div class="tabela bg-light">
	...
	$res = $this->getIgrejaId($id_igreja);
	$total_reg = count($res);
	if($total_reg > 0){
		...
		<table id="example" class="table table-striped table-light table-hover my-4 my-4" style="width:100%">
			...
			<tbody>
				...
				for($i=0; $i < $total_reg; $i++){
					...
					$res_m = $this->getMembros($id_igreja);
			$membrosCad = @count($res_m);
					...
					<tr>
						...
						<td class="esc"><img src="<?=ROTA_IGREJA?>/img/igrejas/<?php echo $foto ?>" width="30px"></td>
						...
						<div class="row">
							...
							<div class="col-md-2">
								<div id="divImg" class="mt-4">
									<img src="<?=ROTA_IGREJA?>/img/igrejas/sem-foto.jpg"  width="130px" id="target">									
								</div>
							</div>
						</div>
				...
				<div class="modal-body">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="col-md-6">
								<div id="divImg" class="mt-4">
									<img src="<?=ROTA_IGREJA?>/img/igrejas/sem-foto.jpg"  width="170px" id="targetlogojpg">									
								</div>
							</div>
						</div>
						...
						<div class="col-md-6">
							...
							<div class="col-md-6">
								<div id="divImg" class="mt-4">
									<img src="<?=ROTA_IGREJA?>/img/igrejas/sem-foto.jpg"  width="170px" id="targetcabjpg">									
								</div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="col-md-6">
								<div id="divImg" class="mt-4">
									<img src="<?=ROTA_IGREJA?>/img/igrejas/sem-foto.jpg"  width="170px" id="targetcartjpg">									
								</div>
							</div>
						</div>
...
<script type="text/javascript">
	...
	function editar(id, nome, telefone, endereco, foto, pastor, video, email){
		...
		$('#target').attr('src', '<?=ROTA_IGREJA?>/img/igrejas/' + foto);
		$('#video').val(video);
	...
	function dados(nome, telefone, endereco, foto, data_cad, matriz, pastor, email){
		...
		$('#foto-dados').attr('src', '<?=ROTA_IGREJA?>/img/igrejas/' + foto);
	...
	function limpar(){
		...
		$('#target').attr('src', '<?=ROTA_IGREJA?>/img/igrejas/sem-foto.jpg');
	}
	...
	function imagens(id, nome, logo, cab, cart){
		...
		$('#targetlogojpg').attr('src', '<?=ROTA_IGREJA?>/img/igrejas/' + logo);
		$('#targetcabjpg').attr('src', '<?=ROTA_IGREJA?>/img/igrejas/' + cab);
		$('#targetcartjpg').attr('src', '<?=ROTA_IGREJA?>/img/igrejas/' + cart);
