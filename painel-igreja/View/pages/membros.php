		...
		<table id="example" class="table table-striped table-light table-hover my-4 my-4" style="width:100%">
			...
			<tbody>
				...
				for($i=0; $i < $total_reg; $i++){
					...
					$res_con = $this->getIgrejaId($igreja);
						if(count($res_con) > 0){
					...
					<tr class="<?php echo $inativa ?>">
						...
						<td class="esc"><img src="<?=ROTA_IGREJA?>/img/membros/<?php echo $foto ?>" width="30px"></td>
						...
						<td>
							...
							<a href="#" onclick="mudarStatus('<?php echo $id ?>', '<?php echo $ativar ?>')" title="<?php echo $ativo ?>">
								...
								<a href="<?=ROTA?>/sistema/rel/relCarteirinha.php?id=<?php echo $id ?>" title="Gerar Carteirinha" target="_blank">
					...
					<div class="row">
						...
						<div class="col-md-2">
							<div id="divImg" class="mt-4">
								<img src="<?=ROTA_IGREJA?>/img/membros/sem-foto.jpg"  width="100px" id="target">									
							</div>
						</div>
...
<script type="text/javascript">
	...
	function editar(id, nome, cpf, email, telefone, endereco, foto, data_nasc, igreja, nome_ig, data_bat, cargo){
		...
		$('#target').attr('src', '<?=ROTA_IGREJA?>img/membros/' + foto);
	...
	function dados(nome, cpf, email, telefone, endereco, foto, data_nasc, data_cad, igreja, data_bat, cargo){
		...
		$('#foto-dados').attr('src', '<?=ROTA_IGREJA?>img/membros/' + foto);
	...
	function limpar(){
		...
		$('#target').attr('src', '<?=ROTA_IGREJA?>img/membros/sem-foto.jpg');
	}
