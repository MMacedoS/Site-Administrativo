...
<div class="row my-3" style="margin-right:20px">
	...
	<div class="col-md-10" align="right">
		<small><small>
			<span class="mx-2"><i class="bi bi-circle-fill text-dark"></i> Item da Igreja </span>
			<span class="mx-2"><i class="bi bi-circle-fill text-danger"></i> Item Emprestado </span>
			<span class="mx-2"><i class="bi bi-circle-fill text-primary"></i> Item de outra Igreja </span>
			<span class="mx-2"><i class="bi bi-circle-fill text-muted"></i> Item Inativo </span>
		</small></small>
	</div>
</div>
